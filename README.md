...
### Motion Capture
  ...
  7. [A sample offboard ROS node](https://github.com/liliocandidior/Badgercopter_Hybrid-Robot-Project/blob/main/track_a_car.py) is attached in this directory, which shows the quadcopter will track the vehicle with mocap marker on the ground, but 0.5 m higher.
